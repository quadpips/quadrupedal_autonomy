...
{
    // auto wbcType = fromRosConfig<std::string>("wbc_controller/wbc_type");

    boost::property_tree::ptree pt;
    boost::property_tree::read_info(controllerConfigFile, pt);
    
    std::string wbcType = "";
    bool verbose = false;
    ocs2::loadData::loadPtreeValue(pt, wbcType, "wbc_type", verbose);
